...
public class UserController {
	...
	public ResponseEntity<?> findById(@PathVariable Long id) {
		...
		if(userEntity==null) {
			throw  new ApiException("Esse usuário não existe", HttpStatus.UNPROCESSABLE_ENTITY);
	...
	@ResponseStatus(HttpStatus.OK)
	public UserModel exchangeUser(
			@RequestBody  
			@Valid ExchangeUserDTO userDTO, 
			@PathVariable Long id){
